...
| Milestone 7 live save matrix | Not yet recorded. | Title query, native save/load identity stability, copied slot, save switching, and clean/unclean client restart acceptance remain required before Milestone 7 is marked complete. |
...
descriptor; the real save/copy/restart matrix remains pending.
